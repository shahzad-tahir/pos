...
Route::get('/details', 'Install\InstallController@details')->name('install.details');
Route::post('/post-details', 'Install\InstallController@postDetails')->name('install.postDetails');
Route::post('/install-alternate', 'Install\InstallController@installAlternate')->name('install.installAlternate');
